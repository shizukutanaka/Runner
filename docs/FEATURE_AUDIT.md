...
**なお、AI/モデレーション機構の技術的な近代化（OpenAI omni-moderationへの更新済み、Policy-as-Prompt化、日本語有害性カバレッジ、Twitch EventSub、エモート認識など）は最新論文・API動向にもとづき `docs/RESEARCH_IMPROVEMENTS.md`（R-1〜R-10）に分離して整理した。R-1/R-3 は本ブランチで実施済み。**
